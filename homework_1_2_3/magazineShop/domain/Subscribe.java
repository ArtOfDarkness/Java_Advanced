...
public class Subscribe {
	...
	public String toString() {
		if (id == 0)
			return "userID#" + userID + ", magazineID#" + magazineID + ", Підписка оформленна: " + subscribeStatus
			...
			return "Subscribe ID#" + id + ": userID#" + userID + ", magazineID#" + magazineID
					+ ", Підписка оформленна: " + subscribeStatus + ", Дата оформлення підписки: " + subscribeDate
